    ...
    <div className="min-h-screen bg-background text-gray-100 overflow-x-hidden">
      ...
      <section className="relative overflow-hidden py-12 sm:py-20 lg:py-32">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          >
            <div>
              <Badge variant="outline" className="mb-6 px-4 py-1 text-sm border-green-800 text-green-300 bg-green-900/20">
                Established 2022
              </Badge>
              <h1 className="text-5xl font-black tracking-tight lg:text-7xl mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">
                Redefining <br />
                <span className="text-green-600">E-commerce.</span>
              </h1>
              <p className="text-base sm:text-lg text-gray-400 leading-relaxed mb-6 sm:mb-8 max-w-lg">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap items-center gap-3 sm:gap-4">
                <Button size="lg" className="h-12 px-8 rounded-full bg-green-600 hover:bg-green-700 text-white shadow-lg shadow-green-500/30">
                  Our Journey
                </Button>
                <Button variant="outline" size="lg" className="h-12 px-8 rounded-full border-gray-800 hover:bg-gray-900 text-white">
                  Meet the Team
                </Button>
              </div>
            </div>
            ...
            <div className="relative h-[300px] sm:h-[400px] lg:h-[600px] w-full">
              <div className="absolute inset-0 bg-gradient-to-tr from-green-600/20 to-emerald-600/20 rounded-[2rem] transform rotate-3 scale-95 blur-2xl" />
              <Image
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            {stats.map((s) => (
              <div key={s.label} className="text-center group cursor-default">
                <div className="text-2xl sm:text-3xl md:text-4xl font-black tracking-tight text-white mb-2 group-hover:scale-110 transition-transform duration-300">
                  {s.value}
                </div>
              ...
              <div key={t.name} className="group relative">
                <div className="relative h-80 w-full overflow-hidden rounded-2xl bg-gray-800">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    ...
                    <p className="text-green-300 font-medium">{t.role}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 pb-12 sm:pb-24">
        <div className="relative rounded-2xl sm:rounded-[2.5rem] overflow-hidden bg-black text-white py-12 sm:py-20 px-4 sm:px-8 text-center">
          ...
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-green-900/50 to-transparent opacity-50" />
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-8">
            ...
            <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input
                ...
                className="flex-1 rounded-full bg-white/10 border border-white/20 px-6 py-4 text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 backdrop-blur-sm"
              />
