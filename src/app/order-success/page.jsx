...
export default function OrderSuccessPage() {
  ...
  return (
    ...
    >
      ...
      {/* Order Summary */}
      <div className="mt-8 bg-gray-900 border border-gray-800 rounded-2xl shadow-sm p-6 space-y-4">
        <h2 className="text-xl font-semibold border-b border-gray-800 pb-2 text-white">Order Summary</h2>
